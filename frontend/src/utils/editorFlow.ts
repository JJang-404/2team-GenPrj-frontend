...
> = {
  ...
  '배달 플랫폼 기능 여부': { text: { x: 8, y: 60, width: 28, height: 6 }, image: { x: 34, y: 58, width: 12, height: 12 } },
...
> = {
  ...
  'template-fallback': [
    { x: 4, y: 32, width: 28, height: 32, rotation: -8 },
    { x: 68, y: 32, width: 26, height: 30, rotation: 8 },
  ],
};
