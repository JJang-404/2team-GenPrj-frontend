...
const INFO_ICON_PATHS = {
  ...
  deliveryPlatformYes: '/info-icons/delivery-yes.png',
  deliveryPlatformNo: '/info-icons/delivery-no.png',
...
export function getAdditionalInfoIcon(projectData: HomeProjectData | null, label: string) {
  ...
  switch (label) {
    ...
    case '배달 플랫폼 기능 여부':
      return info?.deliveryPlatform ? INFO_ICON_PATHS.deliveryPlatformYes : INFO_ICON_PATHS.deliveryPlatformNo;
    case '노키즈존':
